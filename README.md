...
|-----------|------------:|--------:|--------------:|--------:|--------------:|--------:|
| **compatmalloc** | 15.0 ns | 1.30x | 66.40 Mops/s | 0.84x | 148.63 Mops/s | 0.88x |
| glibc | 11.5 ns | 1.00x | 78.95 Mops/s | 1.00x | 168.15 Mops/s | 1.00x |
| jemalloc | 8.5 ns | 0.74x | 100.75 Mops/s | 1.28x | 251.32 Mops/s | 1.49x |
| mimalloc | 11.3 ns | 0.98x | 80.49 Mops/s | 1.02x | 191.51 Mops/s | 1.14x |
| scudo | 49.2 ns | 4.28x | 19.87 Mops/s | 0.25x | 40.21 Mops/s | 0.24x |
...
|-------------|------:|-------------:|---------:|
| python-json | 0.066s | 0.075s | +14% |
| redis | 2.468s | 2.440s | **-2%** |
| nginx | 5.004s | 5.104s | +1% |
| sqlite | 0.159s | 0.131s | **-18%** |
| git | 0.165s | 0.188s | +13% |
