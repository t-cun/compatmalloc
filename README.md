...
|-----------|------------:|--------:|--------------:|--------:|--------------:|--------:|
| **compatmalloc** | 15.2 ns | 1.32x | 66.33 Mops/s | 0.85x | 152.11 Mops/s | 0.91x |
| glibc | 11.5 ns | 1.00x | 78.30 Mops/s | 1.00x | 167.72 Mops/s | 1.00x |
| jemalloc | 8.8 ns | 0.77x | 102.29 Mops/s | 1.31x | 243.33 Mops/s | 1.45x |
| mimalloc | 11.3 ns | 0.98x | 80.35 Mops/s | 1.03x | 190.64 Mops/s | 1.14x |
| scudo | 49.5 ns | 4.30x | 19.74 Mops/s | 0.25x | 39.71 Mops/s | 0.24x |
...
|-------------|------:|-------------:|---------:|
| python-json | 0.069s | 0.079s | +14% |
| redis | 2.446s | 2.428s | **-1%** |
| nginx | 5.104s | 5.104s | **-1%** |
| sqlite | 0.166s | 0.132s | **-21%** |
| git | 0.265s | 0.266s | **0%** |
